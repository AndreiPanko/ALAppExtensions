        ...
        textelement(root)
        {
            ...
            tableelement(C5InvenCustDisc; "C5 InvenCustDisc")
            {
                ...
                textelement(FromDateText)
                {
                    ...
                    begin
                        C5HelperFunctions.TryConvertFromStringDate(FromDateText, CopyStr(DateFormatString, 1, 20), C5InvenCustDisc.FromDate);
                    end;
                }
                ...
                textelement(ToDateText)
                {
                    trigger OnAfterAssignVariable()
                    begin
                        C5HelperFunctions.TryConvertFromStringDate(ToDateText, CopyStr(DateFormatString, 1, 20), C5InvenCustDisc.ToDate);
                    end;
                }
